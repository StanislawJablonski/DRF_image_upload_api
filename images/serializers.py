...
from images.validators import validate_image_size_extension
...
class ImageCreateSerializer(serializers.ModelSerializer):
    ...
    def validate_image(self, value):
        validate_image_size_extension(value)
...
class ExpiringLinkCreateSerializer(serializers.ModelSerializer):
    ...
    def validate_access(self, data):
        if self.context.get('request').user != data.user:
            raise ValidationError('You dont have access to this image')
        return data
